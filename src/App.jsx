  ...
  Coffee: [
    {
      id: 1,
      name: "Espresso",
      desc: "Bold, rich single shot from premium Arabica",
      price: 120,
      tag: "Bestseller",
    },
    {
      id: 2,
      name: "Cappuccino",
      desc: "Velvety microfoam with perfect espresso balance",
      price: 180,
      tag: "",
    },
    {
      id: 3,
      name: "Cold Brew",
      desc: "12-hour steeped, smooth & intensely flavored",
      price: 220,
      tag: "New",
    },
    {
      id: 4,
      name: "Hazelnut Latte",
      desc: "Creamy latte kissed with hazelnut richness",
      price: 240,
      tag: "",
    },
  ],
  Tea: [
    {
      id: 5,
      name: "Masala Chai",
      desc: "Aromatic Indian spiced milk tea",
      price: 80,
      tag: "Classic",
    },
    {
      ...
      desc: "Jasmine-infused premium green tea",
      price: 140,
      tag: "",
    },
    {
      id: 7,
      name: "Kashmiri Kahwa",
      desc: "Saffron & cardamom Kashmiri blend",
      price: 180,
      tag: "Specialty",
    },
  ],
  Mojitos: [
    {
      ...
      desc: "Fresh mint, lime, soda – perfectly chilled",
      price: 160,
      tag: "",
    },
    {
      ...
      desc: "Summer-fresh watermelon & mint fusion",
      price: 180,
      tag: "Popular",
    },
    {
      ...
      desc: "Tropical blue curacao with citrus burst",
      price: 190,
      tag: "Signature",
    },
    {
      id: 11,
      name: "Virgin Mojito",
      desc: "The timeless refreshing classic",
      price: 150,
      tag: "",
    },
  ],
  Shakes: [
    {
      id: 12,
      name: "Oreo Overload",
      desc: "Thick Oreo milkshake with whipped cream",
      price: 220,
      tag: "Bestseller",
    },
    {
      ...
      desc: "Rich Belgian chocolate milkshake",
      price: 200,
      tag: "",
    },
    {
      id: 14,
      name: "Nutella Shake",
      desc: "Indulgent Nutella with roasted hazelnut",
      price: 240,
      tag: "Premium",
    },
    {
      id: 15,
      name: "Mango Madness",
      desc: "Alphonso mango thick shake",
      price: 210,
      tag: "Seasonal",
    },
  ],
  Starters: [
    {
      ...
      desc: "Crispy potato tossed in sweet chilli glaze",
      price: 180,
      tag: "Bestseller",
    },
    {
      id: 17,
      name: "Loaded Fries",
      desc: "Seasoned fries with cheese sauce & jalapeños",
      price: 200,
      tag: "",
    },
    {
      ...
      desc: "House-spiced fries with peri peri seasoning",
      price: 190,
      tag: "",
    },
    {
      ...
      desc: "Crispy Asian-style mixed veg rolls",
      price: 160,
      tag: "",
    },
  ],
  Burgers: [
    {
      id: 20,
      name: "Veg Burger",
      desc: "Crispy patty with fresh slaw & signature sauce",
      price: 180,
      tag: "",
    },
    {
      id: 21,
      name: "Cheese Burger",
      desc: "Double cheese with caramelized onions",
      price: 220,
      tag: "Popular",
    },
    {
      ...
      desc: "Spiced paneer tikka in brioche bun",
      price: 240,
      tag: "Signature",
    },
    {
      id: 23,
      name: "Mushroom Swiss",
      desc: "Sautéed mushroom with Swiss cheese",
      price: 230,
      tag: "",
    },
  ],
  Pizza: [
    {
      id: 24,
      name: "Margherita",
      desc: "San Marzano tomato, fresh basil, mozzarella",
      price: 280,
      tag: "",
    },
    {
      ...
      desc: "Spiced paneer, peppers & tikka sauce",
      price: 340,
      tag: "Bestseller",
    },
    {
      ...
      desc: "Garden vegetables on herb-infused tomato base",
      price: 320,
      tag: "",
    },
    {
      id: 27,
      name: "BBQ Corn Pizza",
      desc: "Sweet corn with smoky BBQ sauce",
      price: 300,
      tag: "",
    },
  ],
  Pasta: [
    {
      ...
      desc: "Creamy béchamel with herbs & parmesan",
      price: 240,
      tag: "",
    },
    {
      ...
      desc: "Dual sauce – creamy meets tangy arrabbiata",
      price: 260,
      tag: "Signature",
    },
    {
      id: 30,
      name: "Arrabbiata",
      desc: "Spicy tomato-basil with garlic & chilli",
      price: 230,
      tag: "",
    },
    {
      id: 31,
      name: "Pesto Pasta",
      desc: "Basil pesto with pine nuts & parmesan",
      price: 270,
      tag: "Premium",
    },
  ],
  Sandwiches: [
    {
      id: 32,
      name: "Club Sandwich",
      desc: "Triple-decker with veggies & cream cheese",
      price: 200,
      tag: "",
    },
    {
      id: 33,
      name: "Grilled Paneer",
      desc: "Spiced paneer with mint chutney & onion",
      price: 220,
      tag: "Popular",
    },
    {
      id: 34,
      name: "Bombay Toast",
      desc: "Classic Bombay-style masala toast",
      price: 160,
      tag: "Classic",
    },
  ],
  Momos: [
    {
      ...
      desc: "Delicate veg dumplings with chilli sauce",
      price: 160,
      tag: "",
    },
    {
      ...
      desc: "Crispy pan-fried dumplings",
      price: 180,
      tag: "Popular",
    },
    {
      id: 37,
      name: "Paneer Momos",
      desc: "Cottage cheese filled steamed dumplings",
      price: 190,
      tag: "",
    },
  ],
  Desserts: [
    {
      ...
      desc: "Warm fudge brownie with vanilla scoop",
      price: 220,
      tag: "Bestseller",
    },
    {
      id: 39,
      name: "Gulab Jamun",
      desc: "Soft milk dumplings in rose saffron syrup",
      price: 140,
      tag: "Classic",
    },
    {
      id: 40,
      name: "Waffles",
      desc: "Belgian waffle with maple & fresh berries",
      price: 260,
      tag: "Premium",
    },
    {
      id: 41,
      name: "Cheesecake",
      desc: "New York style baked cheesecake",
      price: 280,
      tag: "",
    },
  ],
...
const FEATURED_ITEMS = [
  {
    name: "White Sauce Pasta",
    desc: "Silky béchamel, herbs, parmesan perfection",
    price: 240,
    emoji: "🍝",
  ...
  {
    name: "Mix Sauce Pasta",
    desc: "The ultimate dual-sauce experience",
    price: 260,
    emoji: "🫙",
  ...
  {
    name: "Veg Burger",
    desc: "Fresh, crispy, loaded with flavour",
    price: 180,
    emoji: "🍔",
  ...
  {
    name: "Cheese Burger",
    desc: "Double cheese, zero regrets",
    price: 220,
    emoji: "🧀",
  ...
  {
    name: "Loaded Fries",
    desc: "Cheese, jalapeños & house sauce",
    price: 200,
    emoji: "🍟",
  ...
  {
    name: "Honey Chilli Potato",
    desc: "Sweet heat you'll crave again",
    price: 180,
    emoji: "🌶️",
  ...
  },
  {
    ...
    desc: "6 flavours of refreshment",
    price: 160,
    emoji: "🍹",
  ...
  {
    name: "Cold Coffee",
    desc: "Smooth, bold, perfectly chilled",
    price: 180,
    emoji: "☕",
  ...
  {
    name: "Chocolate Shake",
    desc: "Rich Belgian chocolate indulgence",
    price: 200,
    emoji: "🍫",
    gradient: "from-brown-900/40 to-amber-900/40",
  },
];
...
const REVIEWS = [
  {
    name: "Priya Sharma",
    rating: 5,
    text: "Absolutely stunning ambience! The Mix Sauce Pasta is to die for. Perfect date night spot in Kanpur. Will definitely be back!",
    avatar: "PS",
    date: "2 weeks ago",
  },
  {
    name: "Arjun Verma",
    rating: 5,
    text: "Best café in Kanpur hands down. The Cold Brew is exceptional and the vibe is super premium. Feels like a 5-star experience at affordable prices.",
    avatar: "AV",
    date: "1 month ago",
  },
  {
    name: "Sneha Agarwal",
    rating: 5,
    text: "Celebrated my birthday here and it was magical! The team decorated beautifully. Food was amazing, staff super warm. 10/10!",
    avatar: "SA",
    date: "3 weeks ago",
  },
  {
    name: "Rohit Gupta",
    rating: 5,
    text: "Finally, Kanpur has a café that matches big city standards. Honey Chilli Potato and Mojito combo is UNREAL. My new office haunt!",
    avatar: "RG",
    date: "1 week ago",
  },
  {
    name: "Kavya Singh",
    rating: 5,
    text: "The interiors are Instagram-worthy! Every corner is a photo opportunity. Food is fresh and delicious. Loved the Oreo Shake!",
    avatar: "KS",
    date: "5 days ago",
  },
];
  ...
  return (
    <span className="flex gap-0.5">
      {Array.from({ length: n }).map((_, i) => (
        <span key={i} style={{ color: "#C89B3C", fontSize: 14 }}>
          ★
        </span>
      ))}
    </span>
...
function Navbar({ page, setPage, cartCount }) {
  ...
  return (
    <>
      ...
      <div
        className="md:hidden"
        style={{ position: "fixed", bottom: 80, right: 20, zIndex: 998 }}
      >
        <button
          onClick={() => setPage("reserve")}
          style={{
...
function HomePage({ setPage, addToCart }) {
  ...
  const filtered =
    galFilter === "All"
      ? GALLERY_ITEMS
      : GALLERY_ITEMS.filter((g) => g.cat === galFilter);
    ...
    <div style={{ background: "#0F0F0F", color: "#F5F1EA" }}>
      ...
      <section
        style={{
          ...
          justifyContent: "center",
          background:
            "linear-gradient(135deg, #0F0F0F 0%, #1a0f05 50%, #0F0F0F 100%)",
          overflow: "hidden",
        }}
      >
        {/* Ambient orbs */}
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(200,155,60,0.05) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        {/* Grain */}
        ...
        <div
          style={{
            ...
            opacity: 0.03,
            backgroundImage:
              "repeating-linear-gradient(45deg, #C89B3C 0, #C89B3C 1px, transparent 0, transparent 50%)",
        ...
        >
          <div style={{ opacity: 1, transform: "none" }}>
            ...
            >
              ...
              <br />
              <span style={{ color: "#C89B3C", fontStyle: "italic" }}>
                Great Conversations
              </span>
            </h1>
            <p
            ...
            >
              Experience handcrafted beverages, delicious food, cozy interiors,
              and unforgettable moments at Kanpur Café — Kanpur's most loved
              destination.
            </p>
            <div
              style={{
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.target.style.boxShadow =
                    "0 12px 40px rgba(200,155,60,0.35)";
                }}
                onMouseLeave={(e) => {
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            <Reveal>
              ...
              >
                Step into a world where the aroma of freshly brewed coffee
                blends with laughter, where every seat tells a story, and every
                bite creates a memory. Kanpur Café was born from a simple dream
                — to create Kanpur's most beautiful, welcoming, and
              ...
              >
                From intimate date nights to loud birthday celebrations, from
                quiet study sessions to group hangouts — we've crafted every
                corner with intention, every dish with love.
              </p>
            </Reveal>
            <Reveal delay={200}>
              <div
              ...
              >
                {[
                  ...
                  },
                  {
                    icon: "✨",
                    label: "Cozy Ambience",
                    sub: "Instagrammable spaces",
                  },
                  {
                    icon: "❤️",
                    label: "Made With Love",
                    sub: "Every single dish",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
            ...
            {[
              {
                ...
                desc: "We source fresh produce daily to ensure every bite is as flavourful as the first",
              },
              {
                icon: "🛋️",
                title: "Cozy Ambience",
                desc: "Thoughtfully designed spaces that make you feel instantly at home",
              },
              {
                icon: "⚡",
                title: "Fast Service",
                desc: "Warm, prompt service because your time and experience matter to us",
              },
              {
                icon: "💎",
                title: "Affordable Luxury",
                desc: "Premium café experience at prices that make sense for Kanpur",
              },
              {
                icon: "💕",
                title: "Perfect For Dates",
                desc: "Romantic lighting, private corners, and a vibe that sets the mood",
              },
              {
                icon: "🎉",
                title: "Celebrations Welcome",
                desc: "Birthday setups, group parties, and special occasions done right",
              },
            ].map((item, i) => (
            ...
            >
              {REVIEWS.map((_, i) => (
                <button
                  ...
                  style={{
                    width: i === reviewIdx ? 28 : 8,
                    height: 8,
                    borderRadius: 4,
                    border: "none",
                    background:
                      i === reviewIdx ? "#C89B3C" : "rgba(200,155,60,0.3)",
                    cursor: "pointer",
                    transition: "all 0.3s",
                  }}
                />
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            {galCats.map((c) => (
              <button
                key={c}
                onClick={() => setGalFilter(c)}
                style={{
                  fontFamily: "'Poppins',sans-serif",
                  fontSize: 12,
                  letterSpacing: "0.08em",
                  textTransform: "uppercase",
                  background: galFilter === c ? "#C89B3C" : "transparent",
                  color: galFilter === c ? "#0F0F0F" : "#F5F1EA",
          ...
          >
            {filtered.map((item, i) => (
              <div
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = "";
                  e.currentTarget.style.borderColor = "rgba(200,155,60,0.1)";
                }}
              >
          ...
          <div style={{ textAlign: "center", marginTop: 40 }}>
            ...
            >
              Follow us <span style={{ color: "#C89B3C" }}>@KanpurCafe</span>{" "}
              for daily updates ✨
            </p>
          </div>
        </div>
      ...
      <section
        style={{
          ...
          textAlign: "center",
          background:
            "linear-gradient(135deg, #1a0f05 0%, #0F0F0F 50%, #0a0a0a 100%)",
          position: "relative",
          overflow: "hidden",
        }}
      >
        ...
        <Reveal>
          ...
          >
            Join thousands of happy guests who've made Kanpur Café their
            favourite escape. Reserve your spot for an unforgettable experience.
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            <button
              ...
              onMouseEnter={(e) => {
                e.target.style.transform = "translateY(-2px)";
                e.target.style.boxShadow = "0 16px 48px rgba(200,155,60,0.4)";
              }}
              onMouseLeave={(e) => {
                e.target.style.transform = "";
                e.target.style.boxShadow = "";
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${hov ? "#C89B3C" : "rgba(200,155,60,0.12)"}`,
        borderRadius: 4,
        overflow: "hidden",
        transition: "all 0.3s ease",
        transform: hov ? "translateY(-6px)" : "none",
        boxShadow: hov
          ? "0 20px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(200,155,60,0.1)"
          : "none",
      }}
    >
      <div
        ...
        >
          ...
          {addToCart && (
            <button
              ...
              style={{
                background: hov ? "#C89B3C" : "transparent",
                color: hov ? "#0F0F0F" : "#C89B3C",
                border: "1px solid #C89B3C",
                padding: "7px 16px",
                fontSize: 11,
                fontFamily: "'Poppins',sans-serif",
...
function MenuPage({ addToCart }) {
  ...
  const allItems = Object.entries(MENU_DATA).flatMap(([c, items]) =>
    items.map((i) => ({ ...i, cat: c })),
  );
          ...
          {cats.map((c) => (
            <button
              ...
              style={{
                ...
                background: cat === c ? "#C89B3C" : "#1A1A1A",
                color: cat === c ? "#0F0F0F" : "rgba(245,241,234,0.7)",
          ...
          {filtered.map((item) => (
            <MenuCard
              ...
              item={{
                ...item,
                emoji:
                  FEATURED_ITEMS.find((f) => f.name === item.name)?.emoji ||
                  "🍽️",
              }}
              addToCart={addToCart}
            />
...
function GalleryPage() {
  ...
  const items = GALLERY_ITEMS.concat(GALLERY_ITEMS).map((g, i) => ({
    ...g,
    id: i,
  }));
  const filtered =
    filter === "All" ? items : items.filter((g) => g.cat === filter);
        ...
        <Reveal>
          ...
          >
            <div>
              ...
              >
                Founded in 2019, Kanpur Café was born from a simple yet powerful
                dream — to create a space where Kanpur's vibrant youth could
                come together, share stories, and make memories over exceptional
                food and coffee.
              </p>
              <p
                style={{
              ...
              >
                What started as a small coffee shop has grown into Kanpur's most
                beloved café destination, with over 10,000 happy customers and
                counting. Every dish, every corner, every experience is designed
              ...
              {[
                {
                  icon: "🎯",
                  title: "Our Mission",
                  desc: "To craft extraordinary experiences through exceptional food, warm hospitality, and spaces that inspire connection.",
                },
                {
                  icon: "🌟",
                  title: "Our Vision",
                  desc: "To become India's most loved café brand — one city, one cup, one unforgettable memory at a time.",
                },
                {
                  icon: "💫",
                  title: "Our Values",
                  desc: "Quality, Authenticity, Community, Innovation, and an unwavering commitment to our guests' happiness.",
                },
              ].map((v, i) => (
                <div
                  key={i}
          ...
          >
            <div
              style={{
                ...
                width: 1,
                background:
                  "linear-gradient(180deg, #C89B3C 0%, rgba(200,155,60,0.1) 100%)",
                transform: "translateX(-50%)",
              }}
            />
            {[
              {
                year: "2019",
                title: "Founded",
                desc: "Kanpur Café opens its doors with 30 seats and a dream",
              },
              {
                year: "2020",
                title: "1,000 Customers",
                desc: "Despite challenges, we reached our first milestone",
              },
              {
                year: "2021",
                title: "Menu Expansion",
                desc: "Added full food menu & expanded to 70 seats",
              },
              {
                year: "2022",
                title: "Best Café Award",
                desc: "Kanpur's Best New Café by local food critics",
              },
              {
                year: "2023",
                title: "Digital Presence",
                desc: "50K+ Instagram followers; viral Honey Chilli Potato",
              },
              {
                year: "2024",
                title: "10,000 Guests",
                desc: "We reached 10,000 happy customers!",
              },
            ].map((item, i) => (
              <div
                key={i}
      ...
      >
        <div style={{ textAlign: "center", padding: "0 5%", maxWidth: 520 }}>
          ...
          >
            ...
            <strong style={{ color: "#C89B3C" }}>{form.name}</strong>! We've
            sent details to{" "}
            <strong style={{ color: "#C89B3C" }}>{form.email}</strong>.
          </p>
          <div
            style={{
              background: "#1A1A1A",
            ...
            <>
              <div
                ...
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                  background: step >= s ? "#C89B3C" : "#1A1A1A",
                  border: `1px solid ${step >= s ? "#C89B3C" : "rgba(200,155,60,0.2)"}`,
                  fontFamily: "'Poppins',sans-serif",
                  fontWeight: 700,
                  fontSize: 14,
                  color: step >= s ? "#0F0F0F" : "rgba(245,241,234,0.4)",
                }}
              >
                {s}
              </div>
              {i < 1 && (
                <div
                  style={{
                    flex: 1,
                    height: 1,
                    background: step > 1 ? "#C89B3C" : "rgba(200,155,60,0.2)",
                    margin: "0 12px",
                  }}
                />
              )}
          ...
          <div>
              ...
              >
                {times.map((t) => (
                  <button
                    ...
                    onClick={() => set("time", t)}
                    style={{
                      background: form.time === t ? "#C89B3C" : "#1A1A1A",
                      color: form.time === t ? "#0F0F0F" : "#F5F1EA",
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <textarea
                ...
                rows={3}
                placeholder="Birthday setup, dietary needs, etc."
                style={{
                  width: "100%",
                  background: "#1A1A1A",
                  border: "1px solid rgba(200,155,60,0.2)",
  ...
  if (checkoutStep === 2)
    return (
      ...
      >
        ...
        >
          Order #KC{Math.floor(Math.random() * 9000 + 1000)}
        </p>
        <p
          style={{
            fontFamily: "'Poppins',sans-serif",
              ...
              <>
                ...
                >
                  <div style={{ display: "flex", gap: 8 }}>
                    ...
                    <button
                      onClick={() => {
                        if (promo === "KANPUR10") setPromoApplied(true);
                      }}
                      style={{
                        background: "#C89B3C",
                        color: "#0F0F0F",
                ...
                >
                  {[
                    ...
                    ["GST (5%)", `₹${gst}`],
                    ...(promoApplied ? [["Discount", `-₹${discount}`]] : []),
                  ].map(([l, v]) => (
                    <div
                      key={l}
                      style={{
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              Where Great Food Meets Great Conversations. Kanpur's most loved
              café since 2019.
            </p>
          ...
          <div>
            ...
            {["Home", "Menu", "Gallery", "About", "Contact", "Reserve"].map(
              (l) => (
                <button
                  key={l}
                  onClick={() => setPage(l.toLowerCase())}
                  ...
                  onMouseLeave={(e) =>
                    (e.target.style.color = "rgba(245,241,234,0.5)")
                  }
                >
                  {l}
                </button>
          ...
          <div>
            ...
            >
              ...
              <br />
              <br />
              <span style={{ color: "#C89B3C" }}>+91 98765 43210</span>
              <br />
              hello@kanpurcafe.com
            </p>
          </div>
        ...
        >
          ...
          >
            © 2024 Kanpur Café. All rights reserved.
          </p>
          <p
            style={{
              fontFamily: "'Poppins',sans-serif",
  ...
  return (
    <div
      style={{
        ...
        width: `${prog}%`,
        height: 2,
        background: "linear-gradient(90deg, #C89B3C, #f0c96a)",
        zIndex: 9999,
